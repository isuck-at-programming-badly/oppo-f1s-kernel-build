...
static int mtk_pcm_fm_i2s_close(struct snd_pcm_substream *substream)
{
	...
	/*zengling.wu@EXP.BaseDrv.Audio, 2016-05-13, add MTK provide to sovle FM speaker no sound with MTK default process*/
    SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I10,
    ...
    /*zengling.wu@EXP.BaseDrv.Audio, 2016-05-13, add MTK provide to sovle FM speaker no sound with MTK default process end*/
	EnableAfe(false);
