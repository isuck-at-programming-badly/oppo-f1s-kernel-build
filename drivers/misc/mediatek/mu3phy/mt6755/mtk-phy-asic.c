...
PHY_INT32 phy_init_soc(struct u3phy_info *info)
{
	...
	{
	    #ifdef VENDOR_EDIT
        //chaoying.chen@EXP.BaseDrv.OTG, modify otg eyesight for 15311 otg,2016/03/24
		U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_TERM_VREF_SEL_OFST, E60802_RG_USB20_TERM_VREF_SEL,2);
		#endif /* VENDOR_EDIT */
...
void usb_phy_recover(unsigned int clk_on)
{
	...
	{
	    #ifdef VENDOR_EDIT
        //chaoying.chen@EXP.BaseDrv.OTG, modify otg eyesight for 15311,2016/03/24
		U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_TERM_VREF_SEL_OFST, E60802_RG_USB20_TERM_VREF_SEL, 2);
		#endif /* VENDOR_EDIT */
		U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_VRT_VREF_SEL_OFST, E60802_RG_USB20_VRT_VREF_SEL, 7);
		printk("phy_init_soc, iddig_state = %d,get_otg_switch() = %d\r\n", iddig_state,get_otg_switch());
