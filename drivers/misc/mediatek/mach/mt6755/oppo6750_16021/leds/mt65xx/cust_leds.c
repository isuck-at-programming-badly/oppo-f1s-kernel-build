...
#ifdef VENDOR_EDIT
/* liping-m@PhoneSW.Multimedia, 2016/05/11  Add for backlight use lm3697*/
...
#ifdef VENDOR_EDIT
/* liping-m@PhoneSW.Multimedia, 2015/12/23  Add for backlight use lm3630a */
...
//liping-m@PhoneSW.Multimedia, 2016/05/11 Add for sa 3697 backlight
	if(get_PCB_Version()==HW_VERSION__10){
		lm3630a_setbacklight(bkl_level);
	}else{
		lm3697_setbacklight(bkl_level);
	}
...
#ifndef VENDOR_EDIT
//Tong.han@oppo.com, 2016-05-11, Modify for button-backlight using pmic isink0 control 
