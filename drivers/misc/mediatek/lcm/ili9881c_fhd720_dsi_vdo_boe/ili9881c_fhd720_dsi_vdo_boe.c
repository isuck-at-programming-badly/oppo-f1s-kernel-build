...
static struct LCM_setting_table lcm_initialization_video_setting[] = {
	...
	{0x53,1,{0x2c}},
	{0xFF,3,{0x98,0x81,0x01}},
	{0xF3, 1, {0x05}},    //0x00 0x05 0x06 0x07
	{0xFF,3,{0x98,0x81,0x00}},
...
int lcm_set_CABC_mode(int mode)
{
 ...
 void lcm_setbacklight_cabc(unsigned int level)
{
...
if(level >0) 
	...
	lcm_backlight_level_setting[0].para_list[0] = (mapped_level>>8)&0xf;
	lcm_backlight_level_setting[0].para_list[1] = (mapped_level&0xff);	
