...
static struct LCM_setting_table lcm_initialization_video_setting[] = {
    ...
    //gamma
    //{0xEE,1,{0x01}},
    //{0xB0,16,{0x00,0x00,0x00,0x12,0x00,0x30,0x00,0x47,0x00,0x5D,0x00,0x7B,0x00,0x96,0x00,0xBE}},
    //{0xB1,16,{0x00,0xDF,0x01,0x30,0x01,0x71,0x01,0xDB,0x02,0x2E,0x02,0x30,0x02,0x7B,0x02,0xC8}},
    //{0xB2,16,{0x02,0xF7,0x03,0x32,0x03,0x59,0x03,0x8B,0x03,0x9F,0x03,0xB6,0x03,0xC2,0x03,0xCE}},
    //{0xB3,4,{0x03,0xDB,0x03,0xFF}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "nt35521s", "truly nt35521s video mode");
#endif
}
...
void  truly_nt_suspend_power(void)
{
...
#endif
int  truly_g5d_nt35521s_set_cabc_mode(void *handle,unsigned int level)
{
	...
	printk("truly_g5d_nt35521s_set_cabc_mode = %d\n",level);
    value = mapped_level;
...
LCM_DRIVER oppo_nt35521s_truly_g5d_hd720_dsi_vdo_lcm_drv=
{
    .name           	= "oppo_nt35521s_truly_g5d_hd720_dsi_vdo",
