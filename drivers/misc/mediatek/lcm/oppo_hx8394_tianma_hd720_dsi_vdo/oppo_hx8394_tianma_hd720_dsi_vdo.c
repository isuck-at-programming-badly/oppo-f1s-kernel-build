...
{0xB1,10,{0x50,0x0b,0x71,0x89,0x33,0x22,0x71,0x31,0x39,0x25}},
{0xBA,6,{0x63,0x03,0x68,0x6B,0xB2,0xC0}},
{0xB2,6,{0x00,0x80,0x64,0x0E,0x0D,0x2f}},
{0xB4,21,{0x00,0x70,0x00,0x70,0x00,0x70,0x02,0x02,0x84,0x35,0x00,0x1F,0x00,0x70,0x00,0x70,0x00,0x70,0x10,0x0C,0x84}},
{0xD3,33,{0x00,0x00,0x07,0x07,0x00,0x00,0x10,0x00,0x32,0x10,0x05,0x00,0x05,0x32,0x10,0x01,0x00,0x01,0x32,0x10,0x00,0x00,0x00,0x36,0x03,0x09,0x09,0x37,0x00,0x00,0x37,0x0E,0x40}},
{0xD5,44,{0x02,0x03,0x00,0x01,0x06,0x07,0x04,0x05,0x24,0x25,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x20,0x21,0x22,0x23}},
{0xD6,44,{0x05,0x04,0x07,0x06,0x01,0x00,0x03,0x02,0x25,0x24,0x19,0x19,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x23,0x22,0x21,0x20}},
{0xE0,58,{0x00,0x0A,0x1C,0x25,0x29,0x2D,0x31,0x30,0x64,0x75,0x87,0x87,0x92,0xA3,0xA9,0xAC,0xB7,0xB6,0xB1,0xB9,0xC4,0x5F,0x5C,0x5D,0x60,0x60,0x63,0x64,0x7F,0x00,0x0A,0x1C,0x25,0x29,0x2D,0x31,0x30,0x64,0x75,0x87,0x87,0x92,0xA3,0xA9,0xAC,0xB7,0xB6,0xB1,0xB9,0xC4,0x5F,0x5C,0x5D,0x60,0x60,0x63,0x64,0x7F}},
{0xCC,1,{0x07}},
{0x36,1,{0x00}},
{0xC0,2,{0x1F,0x73}},
{0xD4,1,{0x02}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch				= 115;
	...
	register_device_proc("lcd", "hx8394", "tianma video mode");
#endif
}
...
static void lcm_init(void)
{
   ...
   // push_table(lcm_initialization_cmd_setting, sizeof(lcm_initialization_cmd_setting) / sizeof(struct LCM_setting_table), 1);
	...
	LM3630A_Write_Byte(0x01,0x18);  //open PWM
...
int  tianma_himax_set_cabc_mode(void *handle,unsigned int level)
{
	...
	printk("truly_himax_set_cabc_mode = %d\n",level);
    value = mapped_level;
...
LCM_DRIVER oppo_hx8394_tianma_hd720_dsi_vdo_lcm_drv=
{
    .name           	= "oppo_hx8394_tianma_hd720_dsi_vdo",
