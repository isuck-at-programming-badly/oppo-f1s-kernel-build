...
static struct LCM_setting_table lcm_initialization_video_setting[] = {	
	...
	{0xB2,12,{0x65,0x80,0x64,0x10,0x07,0x2F,0x00,0x00,0x00,0x00,0xC0,0x1B}},
	...
	{0xBC,1,{0x00}},
	{0xBD,1,{0x00}},
	{0xC1,43,{0x01,0x00,0x07,0x0E,0x15,0x1C,0x23,0x2B,0x32,0x3A,0x42,0x49,0x51,0x59,0x61,0x69,0x71,0x7A,0x82,0x8A,0x92,0x9A,0xA2,0xAB,0xB3,0xBB,0xC3,0xCC,0xD5,0xDD,0xE6,0xEE,0xF7,0xFF,0x00,0x37,0xEA,0xDF,0x10,0xA3,0x69,0x8A,0xC0}},	
	{0xBD,1,{0x01}},
	{0xC1,42,{0x00,0x07,0x0D,0x14,0x1B,0x23,0x2A,0x32,0x3A,0x41,0x48,0x50,0x57,0x5F,0x67,0x6E,0x76,0x7E,0x86,0x8D,0x95,0x9D,0xA4,0xAC,0xB5,0xBC,0xC4,0xCC,0xD4,0xDC,0xE4,0xEC,0xF5,0x0F,0xDC,0x28,0xD3,0xA2,0x4F,0x16,0x9F,0x40}},
	{0xBD,1,{0x02}},
	{0xC1,42,{0x00,0x07,0x0D,0x14,0x1B,0x23,0x2B,0x33,0x3B,0x43,0x4A,0x52,0x5A,0x61,0x69,0x71,0x79,0x81,0x89,0x90,0x98,0xA0,0xA7,0xB0,0xB7,0xBE,0xC6,0xCE,0xD6,0xDE,0xE5,0xED,0xF5,0x0F,0xF9,0x95,0x7F,0xA2,0x4C,0xBF,0xCD,0x00}},
	{0xBD,1,{0x00}},
	{0x51,1,{0xFF}},
	{0x53,1,{0x24}},
	{0x55,1,{0x11}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "hx8394", "16021 truly video mode");	
#endif	
}
...
static void lcm_init(void)
{
   ...
   // push_table(lcm_initialization_cmd_setting, sizeof(lcm_initialization_cmd_setting) / sizeof(struct LCM_setting_table), 1);
	...
	LM3630A_Write_Byte(0x01,0x19);  //Disable PWM
...
int  truly_himax_set_cabc_mode(void *handle,unsigned int level)
{
...
LCM_DRIVER oppo16021_hx8394_truly_hd720_dsi_vdo_lcm_drv=
{
    .name           	= "oppo16021_hx8394_truly_hd720_dsi_vdo",
