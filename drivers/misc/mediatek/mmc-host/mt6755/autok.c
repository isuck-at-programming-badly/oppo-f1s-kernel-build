...
#ifndef VENDOR_EDIT
//Jingchun.Wang@VENDOR_EDIT, 2016/11/12,
//modify for add new tuning for hynix
...
#else
			//Jingchun.Wang@VENDOR_EDIT, 2016/12/27, all emmc use new autok tuning
			/*if (emmc_manfid != CID_MANFID_HYNIX) 
				uDlySel = (((pInfo->bd_info[0].Bound_Start * 5000) / cycle_value)
					- (1250 - 400)) * cycle_value / 5000;
            else */{
				AUTOK_RAWPRINT("[AUTOK]autok_ds_dly_sel hynix\r\n");
...
int execute_online_tuning_hs400(struct msdc_host *host, u8 *res)
{
	...
	//Jingchun.Wang@VENDOR_EDIT, 2016/12/27, all emmc use new autok tuning
	/*if (emmc_manfid == CID_MANFID_HYNIX) */{
		AUTOK_RAWPRINT("[AUTOK]execute_online_tuning_hs400 hynix\r\n");
