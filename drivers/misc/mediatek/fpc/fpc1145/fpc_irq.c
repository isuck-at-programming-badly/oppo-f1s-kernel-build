...
/*libin@EXP.BaseDrv.fingerprint,2016/04/19 add export version node for 15312 */
extern int IMM_GetOneChannelValue(int dwChannel, int data[4], int* rawdata);
extern int IMM_IsAdcInitReady(void);
int get_export_version_volt_15312(int times)
{
    ...
    {
		printk("[get_export_version_volt] AUXADC is not ready\n");
        return 0;
    }
    i = times ;
    while (i--)
    {
	    ...
	    if(ret_value != 0) 
		{
			printk("[get_export_version_volt] error getting adc value\n");
			i++;
			continue;
		}
        ret += ret_temp;
		printk("[get_export_version_volt] ret_temp=%d,ret_value = %d\n",ret_temp,ret_value);
    }
	ret = ret*1500/4096;
    ret = ret/times;
	return ret;
...
#define FPC_ID1_GPIO  GPIO_FPC_ID1_PIN                  //MT_GPIO_BASE_ADDR|102
#define FPC_ID2_GPIO  GPIO_FPC_ID2_PIN                  //MT_GPIO_BASE_ADDR|78
#ifdef VENDOR_EDIT_15311
/*libin@EXP.BaseDrv.fingerprint,2016/04/19 add export version node for 15312 */
#define FPC_ID1_GPIO_15312  GPIO61 | 0x80000000                  //MT_GPIO_BASE_ADDR|61
#define FPC_ID2_GPIO_15312  GPIO62 | 0x80000000                  //MT_GPIO_BASE_ADDR|62
#endif
...
static int fpc_irq_probe(struct platform_device *plat_dev)
{
	...
	#ifdef VENDOR_EDIT_15311
    int export_version_vol_15312 = 0 ;
    #endif
...
#ifdef VENDOR_EDIT_15311
/*libin@EXP.BaseDrv.fingerprint,2016/04/19 add export version node for 15312 */
	 export_version_vol_15312 = get_export_version_volt_15312(5);
	 if(export_version_vol_15312 > 350 && export_version_vol_15312 <= 550)
	 {
	   	 fpc_id = fpc_get_sensor_id(FPC_ID1_GPIO_15312, FPC_ID2_GPIO_15312, 0);
	  }
	 else
	  {
	   	 fpc_id = fpc_get_sensor_id(FPC_ID1_GPIO, FPC_ID2_GPIO, 0);
	  }	 
	  pr_info("[oppo export version] export_version_vol_15312 = %d mv\n",export_version_vol_15312); 
