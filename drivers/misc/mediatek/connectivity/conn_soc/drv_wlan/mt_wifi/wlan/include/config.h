...
#define CFG_SUPPORT_AUTORN			1
#define CFG_SUPPORT_PREFER_5G		0
/*------------------------------------------------------------------------------
 * SLT Option
 *------------------------------------------------------------------------------
 */
...
#ifndef VENDOR_EDIT
//Yadong.Hu@Prd.Svc.Wifi, 2016/01/21, Modify for
//enable the feature: print source of wake up wlan host
/*
#define CFG_SUPPORT_SUSPEND_SLEEP			0
*/
#else /* VENDOR_EDIT */
#define CFG_SUPPORT_SUSPEND_SLEEP			1
#endif /* VENDOR_EDIT */

//#ifndef VENDOR_EDIT
//LiuMing@PSW.Connectivity.WLAN, 2016/03/17, Modify for [disable security mode change detecting]
/*
