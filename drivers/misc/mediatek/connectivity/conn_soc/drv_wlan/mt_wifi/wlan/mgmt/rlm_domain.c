...
static const UINT_16 g_u2CountryGroup2[] = {
	...
	COUNTRY_CODE_UY, COUNTRY_CODE_VN, COUNTRY_CODE_TW, COUNTRY_CODE_SA,
	COUNTRY_CODE_AE, COUNTRY_CODE_KE, COUNTRY_CODE_KZ, COUNTRY_CODE_MX
};
...
static const UINT_16 g_u2CountryGroup4[] = { COUNTRY_CODE_MM,COUNTRY_CODE_AE };
...
static const UINT_16 g_u2CountryGroup5[] = {
	...
	COUNTRY_CODE_FR, COUNTRY_CODE_AR
};
...
static const UINT_16 g_u2CountryGroup10[] = {
	...
	COUNTRY_CODE_PA, COUNTRY_CODE_VE, COUNTRY_CODE_ZM, COUNTRY_CODE_NP,
	COUNTRY_CODE_BD
};
...
static const UINT_16 g_u2CountryGroup13[] = { COUNTRY_CODE_ID, COUNTRY_CODE_PK, COUNTRY_CODE_IR };
...
#ifdef VENDOR_EDIT
	//Yuanliu.Tang@Connectivity.WiFi.Basic.Custom.FB31, 2017/07/17,
	//Add for WiFi freq
    ,
	{
...
#define REG_DOMAIN_GROUP_NUM \
	...
	DBGLOG(RLM, LOUD, "Domain: u2TargetCountryCode=0x%04x, i=%d, j=%d\n",
			u2TargetCountryCode, i, j);
