...
#define DEVICE_VERSION_IMX258		"imx258"
#define DEVICE_MANUFACUTRE_IMX258	"Sony"
...
static int write_cmos_sensor(kal_uint16 addr, kal_uint32 para)
{
    int ret = 0;
    kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
    ret = iWriteReg((u16) addr , (u32) para , 1,  imgsensor.i2c_write_id);
    return ret;
}
...
static void load_imx258_SPC_Data(void)
{
	...
	{
		if(!read_imx258_eeprom_SPC(0x1B00,IMX258MIPI_SPC_Data,126))
		{
...
static void set_shutter(kal_uint32 shutter)
{
    ...
    #ifdef VENDOR_EDIT
    //jindian.guan@camera driver add for slow shutter

        kal_uint16 slowshot_enable = 0;
        kal_uint16 Multi = 0;


        LOG_INF("shutter is %d",shutter);
        if(shutter > 40000){
            slowshot_enable = 1;
        ...
        LOG_INF("slowshot_32s =%d\n", Multi);
        if(slowshot_enable)
        {
            LOG_INF(" slow shot enable");

            Multi++;
            write_cmos_sensor(0x0104, 1);

            write_cmos_sensor(0x3002, Multi);
...
static void imx258_ImageQuality_Setting(void)
{
	...
	else if (imx258_type == IMX258_HDD_TYPE)	// Based on setting ver0.28
	{
		write_cmos_sensor(0x94C7,0x00);//0xFF);
		write_cmos_sensor(0x94C8,0x00);//0xFF);
		write_cmos_sensor(0x94C9,0x00);//0xFF);
		write_cmos_sensor(0x95C7,0x00);//0xFF);
		write_cmos_sensor(0x95C8,0x00);//0xFF);
		write_cmos_sensor(0x95C9,0x00);//0xFF);
		write_cmos_sensor(0x95C4,0x2F);//0x3F);
		write_cmos_sensor(0x95C5,0x2F);//0x3F);
		write_cmos_sensor(0x95C6,0x2F);//0x3F);
		write_cmos_sensor(0x94C1,0x00);//0x3F);
		write_cmos_sensor(0x94C2,0x00);//0x3F);
		write_cmos_sensor(0x94C3,0x00);//0x3F);
		write_cmos_sensor(0x95C1,0x00);//0x02);
		write_cmos_sensor(0x95C2,0x00);//0x02);
		write_cmos_sensor(0x95C3,0x00);//0x02);
		write_cmos_sensor(0x95BE,0x0F);//0x02);
		write_cmos_sensor(0x95BF,0x0F);//0x02);
		write_cmos_sensor(0x95C0,0x0F);//0x02);
		write_cmos_sensor(0x94D0,0x74);//0x0C);
		write_cmos_sensor(0x94D1,0x74);//0x0C);
		write_cmos_sensor(0x94D2,0x74);//0x0C);
		write_cmos_sensor(0x95D0,0x74);//0x0C);
		write_cmos_sensor(0x95D1,0x74);//0x0C);
		write_cmos_sensor(0x95D2,0x74);//0x0C);
		write_cmos_sensor(0x95CD,0x30);//0x74);
		write_cmos_sensor(0x95CE,0x30);//0x74);
		write_cmos_sensor(0x95CF,0x30);//0x74);
		write_cmos_sensor(0x95CA,0x40);//0x74);
		write_cmos_sensor(0x95CB,0x40);//0x74);
		write_cmos_sensor(0x95CC,0x40);//0x74);
		write_cmos_sensor(0x900E,0x32);//0x16);
		write_cmos_sensor(0x94E2,0x80);//0x16);
		write_cmos_sensor(0x94E3,0x80);//0x16);
		write_cmos_sensor(0x94E4,0x80);//0x16);
		write_cmos_sensor(0x95E2,0x80);//0x16);
		write_cmos_sensor(0x95E3,0x80);//0x16);
		write_cmos_sensor(0x95E4,0x80);//0x28);
		write_cmos_sensor(0x94DF,0x6E);//0x28);
		write_cmos_sensor(0x94E0,0x6E);//0x28);
		write_cmos_sensor(0x94E1,0x6E);//0x28);
		write_cmos_sensor(0x95DF,0x2D);//0x28);
		write_cmos_sensor(0x95E0,0x2D);//0x28);
		write_cmos_sensor(0x95E1,0x2D);//0x32);
		write_cmos_sensor(0x7FCC,0x01);//0xFF);
		write_cmos_sensor(0x7B78,0x00);//0xFF);
		write_cmos_sensor(0x9401,0x35);//0xFF);
		write_cmos_sensor(0x9403,0x23);//0xFF);
		write_cmos_sensor(0x9405,0x23);//0xFF);
		write_cmos_sensor(0x9406,0x00);//0xFF);
		write_cmos_sensor(0x9407,0x31);//0x6E);
		write_cmos_sensor(0x9408,0x00);//0x6E);
		write_cmos_sensor(0x9409,0x1B);//0x6E);
		write_cmos_sensor(0x940A,0x00);//0x6E);
		write_cmos_sensor(0x940B,0x15);//0x6E);
		write_cmos_sensor(0x940D,0x3F);//0x6E);
		write_cmos_sensor(0x940F,0x3F);//0x01);
		write_cmos_sensor(0x9411,0x3F);//0x00);
		write_cmos_sensor(0x9413,0x64);//0x35);
		write_cmos_sensor(0x9415,0x64);//0x23);
		write_cmos_sensor(0x9417,0x64);//0x23);
		write_cmos_sensor(0x941D,0x34);//0x00);
		write_cmos_sensor(0x941F,0x01);//0x31);
		write_cmos_sensor(0x9421,0x01);//0x00);
		write_cmos_sensor(0x9423,0x01);//0x1B);
		write_cmos_sensor(0x9425,0x23);//0x00);
		write_cmos_sensor(0x9427,0x23);//0x15);
		write_cmos_sensor(0x9429,0x23);//0x3F);
		write_cmos_sensor(0x942B,0x2F);//0x3F);
		write_cmos_sensor(0x942D,0x1A);//0x3F);
		write_cmos_sensor(0x942F,0x14);//0x64);
		write_cmos_sensor(0x9431,0x3F);//0x64);
		write_cmos_sensor(0x9433,0x3F);//0x64);
		write_cmos_sensor(0x9435,0x3F);//0x34);
		write_cmos_sensor(0x9437,0x6B);//0x01);
		write_cmos_sensor(0x9439,0x7C);//0x01);
		write_cmos_sensor(0x943B,0x81);//0x01);
		write_cmos_sensor(0x9443,0x0F);//0x23);
		write_cmos_sensor(0x9445,0x0F);//0x23);
		write_cmos_sensor(0x9447,0x0F);//0x23);
		write_cmos_sensor(0x9449,0x0F);//0x2F);
		write_cmos_sensor(0x944B,0x0F);//0x1A);
		write_cmos_sensor(0x944D,0x0F);//0x14);
		write_cmos_sensor(0x944F,0x1E);//0x3F);
		write_cmos_sensor(0x9451,0x0F);//0x3F);
		write_cmos_sensor(0x9453,0x0B);//0x3F);
		write_cmos_sensor(0x9455,0x28);//0x6B);
		write_cmos_sensor(0x9457,0x13);//0x7C);
		write_cmos_sensor(0x9459,0x0C);//0x81);
		write_cmos_sensor(0x945D,0x00);//0x0F);
		write_cmos_sensor(0x945E,0x00);//0x0F);
		write_cmos_sensor(0x945F,0x00);//0x0F);
		write_cmos_sensor(0x946D,0x00);//0x0F);
		write_cmos_sensor(0x946F,0x10);//0x0F);
		write_cmos_sensor(0x9471,0x10);//0x0F);
		write_cmos_sensor(0x9473,0x40);//0x1E);
		write_cmos_sensor(0x9475,0x2E);//0x0F);
		write_cmos_sensor(0x9477,0x10);//0x0B);
		write_cmos_sensor(0x9478,0x0A);//0x28);
		write_cmos_sensor(0x947B,0xE0);//0x13);
		write_cmos_sensor(0x947C,0xE0);//0x0C);
		write_cmos_sensor(0x947D,0xE0);//0x00);
		write_cmos_sensor(0x947E,0xE0);//0x00);
		write_cmos_sensor(0x947F,0xE0);//0x00);
		write_cmos_sensor(0x9480,0xE0);//0x00);
		write_cmos_sensor(0x9483,0x14);//0x10);
		write_cmos_sensor(0x9485,0x14);//0x10);
		write_cmos_sensor(0x9487,0x14);//0x40);
		write_cmos_sensor(0x9501,0x35);//0x2E);
		write_cmos_sensor(0x9503,0x14);//0x10);
		write_cmos_sensor(0x9505,0x14);//0x0A);
		write_cmos_sensor(0x9507,0x31);//0xE0);
		write_cmos_sensor(0x9509,0x1B);//0xE0);
		write_cmos_sensor(0x950B,0x15);//0xE0);
		write_cmos_sensor(0x950D,0x1E);//0xE0);
		write_cmos_sensor(0x950F,0x1E);//0xE0);
		write_cmos_sensor(0x9511,0x1E);//0xE0);
		write_cmos_sensor(0x9513,0x64);//0x14);
		write_cmos_sensor(0x9515,0x64);//0x14);
		write_cmos_sensor(0x9517,0x64);//0x14);
		write_cmos_sensor(0x951D,0x34);//0x35);
		write_cmos_sensor(0x951F,0x01);//0x14);
		write_cmos_sensor(0x9521,0x01);//0x14);
		write_cmos_sensor(0x9523,0x01);//0x31);
		write_cmos_sensor(0x9525,0x14);//0x1B);
		write_cmos_sensor(0x9527,0x14);//0x15);
		write_cmos_sensor(0x9529,0x14);//0x1E);
		write_cmos_sensor(0x952B,0x2F);//0x1E);
		write_cmos_sensor(0x952D,0x1A);//0x1E);
		write_cmos_sensor(0x952F,0x14);//0x64);
		write_cmos_sensor(0x9531,0x1E);//0x64);
		write_cmos_sensor(0x9533,0x1E);//0x64);
		write_cmos_sensor(0x9535,0x1E);//0x34);
		write_cmos_sensor(0x9537,0x6B);//0x01);
		write_cmos_sensor(0x9539,0x7C);//0x01);
		write_cmos_sensor(0x953B,0x81);//0x01);
		write_cmos_sensor(0x9543,0x0F);//0x14);
		write_cmos_sensor(0x9545,0x0F);//0x14);
		write_cmos_sensor(0x9547,0x0F);//0x14);
		write_cmos_sensor(0x9549,0x0F);//0x2F);
		write_cmos_sensor(0x954B,0x0F);//0x1A);
		write_cmos_sensor(0x954D,0x0F);//0x14);
		write_cmos_sensor(0x954F,0x15);//0x1E);
		write_cmos_sensor(0x9551,0x0B);//0x1E);
		write_cmos_sensor(0x9553,0x08);//0x1E);
		write_cmos_sensor(0x9555,0x1C);//0x6B);
		write_cmos_sensor(0x9557,0x0D);//0x7C);
		write_cmos_sensor(0x9559,0x08);//0x81);
		write_cmos_sensor(0x955D,0x00);//0x0F);
		write_cmos_sensor(0x955E,0x00);//0x0F);
		write_cmos_sensor(0x955F,0x00);//0x0F);
		write_cmos_sensor(0x956D,0x00);//0x0F);
		write_cmos_sensor(0x956F,0x10);//0x0F);
		write_cmos_sensor(0x9571,0x10);//0x0F);
		write_cmos_sensor(0x9573,0x40);//0x15);
		write_cmos_sensor(0x9575,0x2E);//0x0B);
		write_cmos_sensor(0x9577,0x10);//0x08);
		write_cmos_sensor(0x9578,0x0A);//0x1C);
		write_cmos_sensor(0x957B,0xE0);//0x0D);
		write_cmos_sensor(0x957C,0xE0);//0x08);
		write_cmos_sensor(0x957D,0xE0);//0x00);
		write_cmos_sensor(0x957E,0xE0);//0x00);
		write_cmos_sensor(0x957F,0xE0);//0x00);
		write_cmos_sensor(0x9580,0xE0);//0x00);
		write_cmos_sensor(0x9583,0x14);//0x10);
		write_cmos_sensor(0x9585,0x14);//0x10);
		write_cmos_sensor(0x9587,0x14);//0x40);
		write_cmos_sensor(0x7F78,0x00);//0x2E);
		write_cmos_sensor(0x7F89,0x00);//0x10);
		write_cmos_sensor(0x7F93,0x00);//0x0A);
		write_cmos_sensor(0x924B,0x1B);//0xE0);
		write_cmos_sensor(0x924C,0x0A);//0xE0);
		write_cmos_sensor(0x9304,0x04);//0xE0);
		write_cmos_sensor(0x9315,0x04);//0xE0);
		write_cmos_sensor(0x9250,0x50);//0xE0);
		write_cmos_sensor(0x9251,0x3C);//0xE0);
		write_cmos_sensor(0x9252,0x14);//0x14);
		write_cmos_sensor(0xD000,0x00);//0x14);
		write_cmos_sensor(0xD001,0x18);//0x14);
		write_cmos_sensor(0xD002,0x00);//0x00);
		write_cmos_sensor(0xD003,0x18);//0x00);
		write_cmos_sensor(0xD004,0x10);//0x00);
		write_cmos_sensor(0xD005,0x57);//0x1B);
		write_cmos_sensor(0xD006,0x0C);//0x0A);
		write_cmos_sensor(0xD007,0x17);//0x04);
		write_cmos_sensor(0xD00A,0x01);//0x04);
		write_cmos_sensor(0xD00B,0x02);//0x50);
		write_cmos_sensor(0xD00D,0x02);//0x3C);
		write_cmos_sensor(0xD00E,0x05);//0x14);
		write_cmos_sensor(0xD00F,0x01);//0x01);
		write_cmos_sensor(0xD011,0x02);//0x20);
		write_cmos_sensor(0xD012,0x09);//0x20);
		write_cmos_sensor(0xD013,0x02);//0x20);
		write_cmos_sensor(0xD015,0x0A);//0x20);
		write_cmos_sensor(0xD016,0x05);//0x20);
		write_cmos_sensor(0xD017,0x01);//0x20);
		write_cmos_sensor(0xD019,0x0A);//0x01);
		write_cmos_sensor(0xD01A,0x09);//0x48);
		write_cmos_sensor(0xD01B,0x02);//0x50);
		write_cmos_sensor(0xD01D,0x06);//0x50);
		write_cmos_sensor(0xD01E,0x15);//0x50);
		write_cmos_sensor(0xD01F,0x01);//0x50);
		write_cmos_sensor(0xD021,0x06);//0x00);
		write_cmos_sensor(0xD022,0x19);//0x18);
		write_cmos_sensor(0xD023,0x02);//0x00);
		write_cmos_sensor(0xD025,0x0E);//0x18);
		write_cmos_sensor(0xD026,0x15);//0x10);
		write_cmos_sensor(0xD027,0x01);//0x57);
		write_cmos_sensor(0xD029,0x0E);//0x0C);
		write_cmos_sensor(0xD02A,0x19);//0x17);
		write_cmos_sensor(0xD02B,0x02);//0x01);
	}
}
...
//jindian.guan modify
	...
	write_cmos_sensor(0x0220,0x00);
	LOG_INF("imgsensor normal video mode\n");
...
/*oppo hufeng 20150515 add for device list*/
				if(deviceInfo_register_value==0x00){
					register_device_proc("Cam_b", DEVICE_VERSION_IMX258, DEVICE_MANUFACUTRE_IMX258);
