...
#define DEVICE_MANUFACUTRE_S5K3P3SP	"Samsung"
...
/*zhaozhengtao 2016/02/19,modify for different module*/
	...
	/*zhengjiang.zhu@EXP CameraDrv, 2016/04/18  Increase ISP drive ability */
	.isp_driving_current = ISP_DRIVING_6MA,  //2ma
	#else 
...
/*oppo hufeng 20150515 add for device list*/
                        if(deviceInfo_register_value==0x00){
                            register_device_proc("Cam_f", DEVICE_VERSION_S5K3P3SP, DEVICE_MANUFACUTRE_S5K3P3SP);
