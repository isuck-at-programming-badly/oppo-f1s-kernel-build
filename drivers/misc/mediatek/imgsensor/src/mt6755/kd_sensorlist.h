...
UINT32 IMX298SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 IMX298SEMCO_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
{
/*IMX*/
#if defined(IMX298SEMCO_MIPI_RAW)
    {IMX298SEMCO_SENSOR_ID, SENSOR_DRVNAME_IMX298SEMCO_MIPI_RAW, IMX298SEMCO_MIPI_RAW_SensorInit},
#endif
#if defined(IMX298SUNNY_MIPI_RAW)
    {IMX298SUNNY_SENSOR_ID, SENSOR_DRVNAME_IMX298SUNNY_MIPI_RAW, IMX298SUNNY_MIPI_RAW_SensorInit},
#endif
/*S5K*/
