...
static int yas_gs_enable(int en)
{
	return 0;
}

static int yas_gs_set_delay(u64 ns)
{
	return 0;
}
static int yas_gs_open_report_data(int open)
{
	return 0;
}

static int yas_rv_enable(int en)
{
	return 0;
}

static int yas_rv_set_delay(u64 ns)
{
	return 0;
}
static int yas_rv_open_report_data(int open)
{
	return 0;
}

static int yas_gr_enable(int en)
{
	return 0;
}

static int yas_gr_set_delay(u64 ns)
{
	return 0;
}
static int yas_gr_open_report_data(int open)
{
	return 0;
}

static int yas_la_enable(int en)
{
	return 0;
}

static int yas_la_set_delay(u64 ns)
{
	return 0;
}
static int yas_la_open_report_data(int open)
{
	return 0;
}
...
/*
	...
	//#ifdef AKM_Pseudogyro
	ctl.gs_enable = yas_gs_enable;
	ctl.gs_set_delay  = yas_gs_set_delay;
	ctl.gs_open_report_data = yas_gs_open_report_data;
	ctl.rv_enable = yas_rv_enable;
	ctl.rv_set_delay  = yas_rv_set_delay;
	ctl.rv_open_report_data = yas_rv_open_report_data;
	ctl.gr_enable = yas_gr_enable;
	ctl.gr_set_delay  = yas_gr_set_delay;
	ctl.gr_open_report_data = yas_gr_open_report_data;
	ctl.la_enable = yas_la_enable;
	ctl.la_set_delay  = yas_la_set_delay;
	ctl.la_open_report_data = yas_la_open_report_data;
	//#endif
