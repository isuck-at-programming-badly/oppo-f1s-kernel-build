...
#ifdef VENDOR_EDIT
/*Chaoying.Chen@Prd6.BaseDrv.Power.Basic,2016/12/19 Add for modem wake up source */
#define MODEM_WAKEUP_SRC_NUM 8
#define MD_LOG_WAKEUP_1 6
#define MUXD_WAKEUP 10
#define NVRAM_WAKEUP 14
#define DATA_WAKEUP 20
			...
			if(first_enter == 1){
			    switch(ccci_h.channel){
			        ...
			        case DATA_WAKEUP:
                        ...
                        modem_wakeup_source = ccci_h.channel;
