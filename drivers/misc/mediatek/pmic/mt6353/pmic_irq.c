...
#include <mach/pmic_throttling_dlpt.h>
...
#define PMIC_INT_REG_NUMBER  4
 u64 pmic_wakesrc_x_count[PMIC_INT_REG_NUMBER][PMIC_INT_WIDTH] = {
	 { 0 },
	 { 0 },
	 { 0 },
	 { 0 },
...
const char *pmic_interrupt_status_name[PMIC_INT_REG_NUMBER][PMIC_INT_WIDTH] = {
	{
	[0] = " RG_INT_STATUS_PWRKEY",
	[1] = " RG_INT_STATUS_HOMEKEY",
	[2] = " RG_INT_STATUS_PWRKEY_R",
	[3] = " RG_INT_STATUS_HOMEKEY_R",
	[4] = " RG_INT_STATUS_THR_H",
	[5] = " RG_INT_STATUS_THR_L",
	[6] = " RG_INT_STATUS_BAT_H",
	[7] = " RG_INT_STATUS_BAT_L",
	[8] = " ",
	[9] = " RG_INT_STATUS_RTC",
	[10] = " RG_INT_STATUS_AUDIO",
	[11] = " ",
	[12] = " RG_INT_STATUS_ACCDET",
	[13] = " RG_INT_STATUS_ACCDET_EINT",
	[14] = " RG_INT_STATUS_ACCDET_NEGV",
	[15] = " RG_INT_STATUS_NI_LBAT_INT",
	},
	{
	[0] = " RG_INT_STATUS_VCORE_OC",
	[1] = " RG_INT_STATUS_VPROC_OC",
	[2] = " RG_INT_STATUS_VS1_OC",
	[3] = " RG_INT_STATUS_VPA_OC",
	[4] = " RG_INT_STATUS_SPKL_D",
	[5] = " RG_INT_STATUS_SPKL_AB",
	[6] = " ",
	[7] = " ",
	[8] = " ",
	[9] = " ",
	...
	[13] = " ",
	[14] = " ",
	[15] = " RG_INT_STATUS_LDO_OC",
	},
	{
	[0] = " RG_INT_STATUS_TYPE_C_L_MIN",
	[1] = " RG_INT_STATUS_TYPE_C_L_MAX",
	[2] = " RG_INT_STATUS_TYPE_C_H_MIN",
	[3] = " RG_INT_STATUS_TYPE_C_H_MAX",
	[4] = " RG_INT_STATUS_AUXADC_IMP",
	[5] = " RG_INT_STATUS_NAG_C_DLTV",
	[6] = " RG_INT_STATUS_TYPE_C_CC_IRQ",
	[7] = " RG_INT_STATUS_CHRDET_EDGE",
	[8] = " RG_INT_STATUS_OV",
	[9] = " RG_INT_STATUS_BVALID_DET",
	[10] = " RG_INT_STATUS_RGS_BATON_HV",
	[11] = " RG_INT_STATUS_VBATON_UNDET",
	[12] = " RG_INT_STATUS_WATCHDOG",
	[13] = " RG_INT_STATUS_PCHR_CM_VDEC",
	[14] = " RG_INT_STATUS_CHRDET",
	[15] = " RG_INT_STATUS_PCHR_CM_VINC",
	},
	{
	[0] = " RG_INT_STATUS_FG_BAT_H",
	[1] = " RG_INT_STATUS_FG_BAT_L",
	[2] = " RG_INT_STATUS_FG_CUR_H",
	[3] = " RG_INT_STATUS_FG_CUR_L",
	[4] = " RG_INT_STATUS_FG_ZCV",
	[5] = " ",
	[6] = " ",
	[7] = " ",
	[8] = " ",
 ...
 ******************************************************************************/
#ifdef CONFIG_MTK_TYPEC_SWITCH_MT6353
 ...
 * Chrdet Int Handler
 ******************************************************************************/
#ifdef CONFIG_OPPO_TOUCHPANEL_FT5436
extern int usb_check(int usb_state);
#endif

void chrdet_int_handler(void)
{
	printk(KERN_ERR "===!!!!!%s: PMIC CHRDET status[%d]!!!!!===\n", __func__, pmic_get_register_value(PMIC_RGS_CHRDET));//oppo sjc add
...
int pmic_int_check(char * wakeup_name)         
{
	...
	for (i = 0; i < ARRAY_SIZE(interrupts); i++) {
		...
		for (j = 0; j < PMIC_INT_WIDTH; j++) {
			if ((int_status_val) & (1 << j)) {
				PMICLOG("[PMIC_INT][%s]\n", interrupts[i].interrupts[j].name);
				strcpy(wakeup_name, interrupts[i].interrupts[j].name);
			    ret = i*j;
