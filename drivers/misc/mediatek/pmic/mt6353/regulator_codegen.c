#include <mach/regulator_codegen.h>
...
static const int vcama_voltages[] = {
	...
	2800000,
  #ifdef VENDOR_EDIT
  /*Xiongxing@Prd6.BaseDrv.Camera, 2016/08/17 add for [increase pmic voltage CAMA to 2.94V]*/
	2940000,
    2960000,
  #endif
};
...
{
	pr_debug("ldo vtcxo24 is_enabled\n");
...
{
	pr_debug("ldo vtcxo24 set_voltage_sel: %d\n", selector);
...
{
	pr_debug("ldo vtcxo24 get_voltage_sel\n");
...
static int pmic_ldo_vtcxo24_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vtcxo24 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vxo22 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vxo22 get_voltage_sel\n");
...
{
	pr_debug("ldo vsram_proc enable\n");
	//return mtk_regulator_enable(rdev);
...
{
	pr_debug("ldo vsram_proc disable\n");
	//return mtk_regulator_disable(rdev);
	if (rdev->use_count == 0) {
		pr_err("regulator name=%s should not disable( use_count=%d)\n", rdev->desc->name,
			rdev->use_count);
...
{
	pr_debug("ldo vsram_proc is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vsram_proc set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vsram_proc get_voltage_sel\n");
...
{
	pr_debug("ldo vldo28_0 is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vldo28_0 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vldo28_0 get_voltage_sel\n");
...
static int pmic_ldo_vldo28_0_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vldo28_0 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vldo28_1 is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vldo28_1 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
	mt6353_upmu_set_rg_vldo28_vosel(selector);
...
{
	pr_debug("ldo vldo28_1 get_voltage_sel\n");
...
static int pmic_ldo_vldo28_1_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vldo28_1 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vtcxo28 is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vtcxo28 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vtcxo28 get_voltage_sel\n");
...
static int pmic_ldo_vtcxo28_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vtcxo28 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vrf18 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vrf18 get_voltage_sel\n");
...
static int pmic_ldo_vrf18_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vrf18 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vrf12 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vrf12 get_voltage_sel\n");
...
{
	pr_debug("ldo vcn28 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vcn28 get_voltage_sel\n");
...
{
	pr_debug("ldo vcn18 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vcn18 get_voltage_sel\n");
...
static int pmic_ldo_vcn18_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vcn18 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vcama set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vcama get_voltage_sel\n");
...
static int pmic_ldo_vcama_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vcama list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vcamio set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vcamio get_voltage_sel\n");
...
{
	pr_debug("ldo vcamd set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vcamd get_voltage_sel\n");
...
static int pmic_ldo_vcamd_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vcamd list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vaux18 is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vaux18 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vaux18 get_voltage_sel\n");
...
static int pmic_ldo_vaux18_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vaux18 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vaud28 is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vaud28 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vaud28 get_voltage_sel\n");
...
static int pmic_ldo_vaud28_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vaud28 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vdram set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vdram get_voltage_sel\n");
...
static int pmic_ldo_vdram_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vdram list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vio28 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vio28 get_voltage_sel\n");
...
{
	pr_debug("ldo vusb33 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vusb33 get_voltage_sel\n");
...
{
	pr_debug("ldo vemc33 is_enabled\n");
	//return mtk_regulator_is_enabled(rdev);
...
{
	pr_debug("ldo vemc33 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vemc33 get_voltage_sel\n");
...
static int pmic_ldo_vemc33_list_voltage(struct regulator_dev *rdev, unsigned selector)
{
	...
	pr_debug("ldo vemc33 list_voltage: %d\n", voltage);
	return voltage;
}
...
{
	pr_debug("ldo vio18 set_voltage_sel: %d\n", selector);
	//return mtk_regulator_set_voltage_sel(rdev, selector);
...
{
	pr_debug("ldo vio18 get_voltage_sel\n");
...
struct mtk_regulator mtk_ldos[] = {
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vtcxo24, ldo, vtcxo24_voltages,
	...
	REGULAR_VOLTAGE_REGULATOR_GEN(vsram_proc, ldo, 600000, 1393750, 6250, 0,
		LDO_VOL_EN, 1, PMIC_LDO_VSRAM_PROC_EN, PMIC_LDO_VSRAM_PROC_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vldo28, ldo, vldo28_0_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VLDO28_EN_0, PMIC_RG_VLDO28_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vldo28_1, ldo, vldo28_1_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VLDO28_EN_1, PMIC_RG_VLDO28_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vtcxo28, ldo, vtcxo28_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VTCXO28_EN, PMIC_RG_VTCXO28_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vrf18, ldo, vrf18_voltages,
		LDO_EN, 1, PMIC_LDO_VRF18_EN, NULL),
	...
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vcn18, ldo, vcn18_voltages,
		LDO_EN, 1, PMIC_LDO_VCN18_EN, NULL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vcama, ldo, vcama_voltages,
	...
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vcamd, ldo, vcamd_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VCAMD_EN, PMIC_RG_VCAMD_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vaux18, ldo, vaux18_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VAUX18_EN, PMIC_RG_VAUX18_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vaud28, ldo, vaud28_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VAUD28_EN, PMIC_RG_VAUD28_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vdram, ldo, vdram_voltages,
	...
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vio28, ldo, vio28_voltages,
		LDO_EN, 1, PMIC_LDO_VIO28_EN, NULL),
	...
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vusb33, ldo, vusb33_voltages,
		LDO_EN, 1, PMIC_LDO_VUSB33_EN, NULL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vemc, ldo, vemc33_voltages,
		LDO_VOL_EN, 1, PMIC_LDO_VEMC33_EN, PMIC_RG_VEMC33_VOSEL),
	NON_REGULAR_VOLTAGE_REGULATOR_GEN(vio18, ldo, vio18_voltages,
		LDO_EN, 1, PMIC_LDO_VIO18_EN, NULL),
