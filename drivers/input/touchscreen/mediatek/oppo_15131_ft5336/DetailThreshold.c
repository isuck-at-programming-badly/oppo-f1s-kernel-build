...
void OnGetTestItemParam(char *strItemName, char *strIniFile, int iDefautValue)
{
	...
	{		
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_SCap_DetailThreshold.TempData[k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
void OnInit_DThreshold_RawDataTest(char *strIniFile)
{
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RawDataTest_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RawDataTest_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RawDataTest_Low_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RawDataTest_Low_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RawDataTest_High_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RawDataTest_High_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
/*
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.TxShortAdvance[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
void OnInit_DThreshold_SCapRawDataTest(char *strIniFile)
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapRawDataTest_OFF_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapRawDataTest_OFF_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				{
					g_stCfg_MCap_DetailThreshold.SCapRawDataTest_OFF_Max[i][j] = a_to_i(SingleItem);
				}
				else
				{
	...
	{						
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapRawDataTest_OFF_Min[i][j] = a_to_i(SingleItem);
				}
				else
				{
...
*/
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapRawDataTest_ON_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapRawDataTest_ON_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapRawDataTest_ON_Max[i][j] = a_to_i(SingleItem);
				}
				else
				{
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapRawDataTest_ON_Min[i][j] = a_to_i(SingleItem);
				}
				else
				{
...
void OnInit_DThreshold_SCapCbTest(char *strIniFile)
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Max[i][j] = a_to_i(SingleItem);
				}
				else
				{
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Min[i][j] = a_to_i(SingleItem);
				}
				else
				{
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max[i][j] = a_to_i(SingleItem);
				}
				else
				{
	...
	for(int i = 0; i < 2; i++)
	{
		...
		if(dividerPos > 0)
		{
			for(int j = 0; j < iLenght; j++)
			{
				...
				if(!SingleItem.IsEmpty())
				{
					g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Min[i][j] = a_to_i(SingleItem);
				}
				else
				{
...
void OnInit_DThreshold_RxLinearityTest(char *strIniFile)
{
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.RxLinearityTest_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
void OnInit_DThreshold_TxLinearityTest(char *strIniFile)
{
	...
	for(i = 0; i < g_ScreenSetParam.iUsedMaxTxNum; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.TxLinearityTest_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
void OnInit_DThreshold_ForceTouch_SCapRawDataTest(char *strIniFile)
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapRawDataTest_OFF_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapRawDataTest_OFF_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
//printk("%d:%d\r\n",MinValue, MaxValue);
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapRawDataTest_ON_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapRawDataTest_ON_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
...
void OnInit_DThreshold_ForceTouch_SCapCbTest(char *strIniFile)
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapCbTest_ON_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapCbTest_ON_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapCbTest_OFF_Max[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
	...
	for(i = 0; i < 2; i++)
	{
		...
		for(j=0; j<dividerPos; j++) 
		{
			if(',' == strValue[j]) 
			{
				g_stCfg_MCap_DetailThreshold.ForceTouch_SCapCbTest_OFF_Min[i][k] = (short)(a_to_i(str_tmp));
				index = 0;
				memset(str_tmp, 0x00, sizeof(str_tmp));
				k++;
			} 
