...
#define GPIO_TP_ID1 GPIO21
#define GPIO_TP_ID2 GPIO19
...
//huqiao@EXP.BasicDrv.Basic 2016/5/6 add test tp
static int tp_id = 1;
...
static struct device *focal_dev;
...
#ifdef SPEC_GESTURE_COORD_COMPRESS_ENABLED
static int _compress_coordinate(unsigned char *buf, int pointnum) // ??¨¨|¡§???|¡§??|¡§?????¡ìoy
{
